...
/**
 * Thrown when a result cannot be returned because its value exceeds the range of its type.
 * This may also be thrown when there is overflow in intermediate calculations.
 */
